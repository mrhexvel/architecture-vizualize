		...
		<div className="home">
			...
			<section className="hero">
				<div className="announce">
					...
					<p>Introducing VizAX</p>
				</div>

				<h1>Build beautiful spaces at the speed of thought with VizAX</h1>
				<p className="subtitle">
					Visualize your ideas, collaborate with your team, and bring your
						...
						{projects.map(
							({ id, name, renderedImage, sourceImage, timestamp }) => (
								<div
									...
									onClick={() => navigate(`/vizualizer/${id}`)}
								>
